        ...
        <div className='flex flex-col rounded-2xl overflow-hidden justify-between font-raleway border-4 border-teal-100 border-b-teal-600'>
            ...
            <div className="flex">
                <Link to={`/editarsetores/${setor.id}`}
                    className='w-full bg-slate-200 hover:bg-teal-700 flex items-center justify-center py-2'>
                    <button>Editar</button>
                </Link>

                <Link to={`/deletarsetores/${setor.id}`}
                    className='text-slate-100 bg-red-400 hover:bg-red-700 w-full items-center justify-center'>
